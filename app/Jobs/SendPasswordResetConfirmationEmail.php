...
class SendPasswordResetConfirmationEmail implements ShouldQueue, ShouldBeUnique
{
    use Dispatchable;
    ...
    {
        return 'password-reset-confirmation-' . $this->user->id;
    }

    private const TEMPLATE_SLUG = 'reset_password_confirmation';
    ...
    public function handle(): void
    {
        ...
        $this->sendUsingTemplate(
            ...
            fallbackSubject: 'Your password has been reset successfully',
            fallbackBody: <<<'HTML'
                <p>Hello {{NAME}},</p>
