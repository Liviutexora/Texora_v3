...
return [
    ...
    */
    ...
    'settings'       => [
        ...
        'middleware' => [
            'web',
            \App\Http\Middleware\BlockDocsWhenDisabled::class,
        ]
    ],
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Slotara',
        'description'     => 'Official documentation for Slotara — Multi-Tenant Booking SaaS built on Laravel 12, Filament 5 & Livewire 3.',
        'keywords'        => 'slotara, booking, saas, multi-tenant, laravel, filament',
        'og'              => [
            'title'       => 'Slotara Documentation',
            'type'        => 'article',
            'url'         => '',
            'image'       => '',
            'description' => 'Official documentation for Slotara booking SaaS.',
        ]
    ],
